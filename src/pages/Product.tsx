    ...
    <div className="flex justify-center items-center min-h-screen bg-blue-400 overflow-auto">
      <div className="bg-white p-6 md:p-20 rounded-lg shadow-2xl w-full max-w-lg">
        <div className="flex flex-col justify-center space-y-5">
          <h2 className="font-serif text-xl font-medium text-center text-black">
            Product Master
          </h2>
          <p className="font-serif text-black-500 text-center">
            Add New Products
          </p>
          <form
            noValidate
          ...
          >
            ...
            <div className="flex flex-col  md:flex-row space-y-2 md:space-y-0 md:space-x-2">
              <button
                type="submit"
                className="px-5 py-3 text-xs md:text-sm bg-blue-500 text-white border-gray-300 rounded-md"
              >
                Create Product
              </button>
            </div>
